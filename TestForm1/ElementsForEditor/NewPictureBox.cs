...
namespace TestForm1
{
    public class NewPictureBox:Label
    {
        ...
        public NewPictureBox(Form1 formPar)
        {
            formParent = formPar;
        }
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[7].Nodes[indexPictureDinamicB];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serPictureDinamicBox[indexPictureDinamicB].childX = Location.X;
            formParent.serPictureDinamicBox[indexPictureDinamicB].childY = Location.Y;
        }
    }
}
