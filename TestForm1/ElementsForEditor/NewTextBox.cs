...
namespace TestForm1
{
    public class NewTextBox:TextBox
    {
        ...
        public NewTextBox(Form1 formPar)
        {
            formParent = formPar;
        }
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[2].Nodes[indexTextB];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serTextBox[indexTextB].X = Location.X;
            formParent.serTextBox[indexTextB].Y = Location.Y;
        }
    }
}
