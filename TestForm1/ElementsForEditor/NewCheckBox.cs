...
namespace TestForm1
{
    public class NewCheckBox:CheckBox
    {
        ...
        public NewCheckBox(Form1 formPar)
        {
            formParent = formPar;
        }
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[3].Nodes[indexCheckB];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serCheckBox[indexCheckB].X = Location.X;
            formParent.serCheckBox[indexCheckB].Y = Location.Y;
        }
    }
}
