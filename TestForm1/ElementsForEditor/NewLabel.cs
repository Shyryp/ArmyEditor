...
namespace TestForm1
{
    public class NewLabel:Label
    {
        ...
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[1].Nodes[indexLab];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serLabel[indexLab].X = Location.X;
            formParent.serLabel[indexLab].Y = Location.Y;
        }
