...
namespace TestForm1
{
    public class NewPictureDinamicBox:PictureBox
    {
        ...
        public NewPictureDinamicBox(Form1 formPar)
        {
            formParent = formPar;
        }
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[6].Nodes[indexPictureDinamicB];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serPictureDinamicBox[indexPictureDinamicB].X = Location.X;
            formParent.serPictureDinamicBox[indexPictureDinamicB].Y = Location.Y;
        }
    }
}
