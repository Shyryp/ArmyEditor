...
namespace TestForm1
{
    public class NewPictureStaticBox:PictureBox
    {
        public int indexPictureStaticB = 0;
        ...
        public NewPictureStaticBox(Form1 formPar)
        {
            formParent = formPar;
        }
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[5].Nodes[indexPictureStaticB];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serPictureStaticBox[indexPictureStaticB].X = Location.X;
            formParent.serPictureStaticBox[indexPictureStaticB].Y = Location.Y;
        }
    }
}
