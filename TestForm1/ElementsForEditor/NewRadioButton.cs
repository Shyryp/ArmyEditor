...
namespace TestForm1
{
    public class NewRadioButton:RadioButton
    {
        ...
        public NewRadioButton(Form1 formPar)
        {
            formParent = formPar;
        }
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            IsDragMode = true;
            formParent.treeView1.SelectedNode = formParent.treeView1.Nodes[4].Nodes[indexRadioB];
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            ...
            formParent.serRadioButton[indexRadioB].X = Location.X;
            formParent.serRadioButton[indexRadioB].Y = Location.Y;
        }
    }
}
